/* ============================================================================
   Interactive sandbox engines (extracted from router.js, Phase 2 router
   decomposition).

   Every function here is a self-contained, ungraded exploration surface
   mounted by router.js's mountVisualizer via the registry built in
   buildInteractiveItems. This file is a classic script loaded before
   router.js in index.html -- no ES modules, no fetch, no CDN -- so the app
   keeps running unchanged from the file:// protocol.
   ============================================================================ */
