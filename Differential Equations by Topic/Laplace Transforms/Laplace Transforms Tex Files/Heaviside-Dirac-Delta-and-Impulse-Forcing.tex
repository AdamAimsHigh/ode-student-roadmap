...
\begin{tikzpicture}[>=stealth, scale=1.0]
  ...
  \node[workpurple, align=center] at (1.5,0.95) {\small off\\[-2pt]\small $u_a = 0$};
  \node[workpurple, align=center] at (4.6,1.95) {\small on, $u_a = 1$};
\end{tikzpicture}
\end{center}
\begin{center}
\small\itshape The unit step $u_a(t)$: a clean jump discontinuity of height $1$ at $t = a$. Open circle = value not attained; filled circle = value attained.
\end{center}
